...
module.exports = function(settings) {
	...
	module.getSQData = function(cb) {
		...
		sq.getInfo(function(err, info) {
			...
			try {
				version = fs.readFileSync(path.join(server_config.ark_path, "version.txt")).toString();
			} catch (err) {
				version = "0";
			}
		});
