...
module.exports = function(options) {	
	...
	var settings;
	try {
		settings = JSON.parse(fs.readFileSync(options.config_file, 'utf8'));
		...
		fs.writeFileSync(options.config_file, JSON.stringify(settings, null, 4));
		console.error("Your " + options.config_file + " has been initialized, please edit it before running again!");
		process.exit(1);
	}
